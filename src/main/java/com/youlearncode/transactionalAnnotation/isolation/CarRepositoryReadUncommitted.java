...
@Repository
@Profile("readuncommitted & isolation")
public class CarRepositoryReadUncommitted extends AbstractCarRepository implements CarRepository {

    @Autowired
    public CarRepositoryReadUncommitted(JdbcTemplate jdbcTemplate, ApplicationContext applicationContext) {
    ...
    public void demonstrateIsolationType(Car car) throws Exception {
        ...
        var bean = applicationContext.getBean("carRepositoryReadUncommitted", CarRepositoryReadUncommitted.class);
