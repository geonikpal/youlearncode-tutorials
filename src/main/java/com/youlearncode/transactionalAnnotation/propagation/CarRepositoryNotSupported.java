...
@Repository
@Profile("propagation & notsupported")
public class CarRepositoryNotSupported extends AbstractCarRepository implements CarRepository {

    @Autowired
    public CarRepositoryNotSupported(JdbcTemplate jdbcTemplate, ApplicationContext applicationContext) {
    ...
    public void insertCarAndUpdateCar(Car car) throws Exception {
        ...
        var bean = ((CarRepositoryNotSupported) applicationContext.getBean("carRepositoryNotSupported"));
