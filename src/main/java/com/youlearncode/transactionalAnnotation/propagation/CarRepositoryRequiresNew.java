...
@Repository
@Profile("propagation & requiresnew")
public class CarRepositoryRequiresNew extends AbstractCarRepository implements CarRepository {

    @Autowired
    public CarRepositoryRequiresNew(JdbcTemplate jdbcTemplate, ApplicationContext applicationContext) {
    ...
    public void insertCarAndUpdateCar(Car car) throws Exception {
        ...
        var bean = ((CarRepositoryRequiresNew) applicationContext.getBean("carRepositoryRequiresNew"));
