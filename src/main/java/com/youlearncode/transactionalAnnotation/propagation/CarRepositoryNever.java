...
@Repository
@Profile("propagation & never")
public class CarRepositoryNever extends AbstractCarRepository implements CarRepository {

    @Autowired
    public CarRepositoryNever(JdbcTemplate jdbcTemplate, ApplicationContext applicationContext) {
    ...
    public void insertCarAndUpdateCar(Car car) throws Exception {
        ...
        var bean = ((CarRepositoryNever) applicationContext.getBean("carRepositoryNever"));
