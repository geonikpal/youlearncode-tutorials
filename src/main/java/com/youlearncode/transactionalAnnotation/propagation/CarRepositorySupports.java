...
@Repository
@Profile("propagation & supports")
public class CarRepositorySupports extends AbstractCarRepository implements CarRepository {

    @Autowired
    public CarRepositorySupports(JdbcTemplate jdbcTemplate, ApplicationContext applicationContext) {
...
//    @Transactional(propagation = Propagation.REQUIRED)
    public void insertCarAndUpdateCar(Car car) throws Exception {
        ...
        var bean = ((CarRepositorySupports) applicationContext.getBean("carRepositorySupports"));
