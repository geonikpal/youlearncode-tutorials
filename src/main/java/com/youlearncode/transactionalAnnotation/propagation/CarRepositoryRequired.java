...
@Repository
@Profile("propagation & required")
public class CarRepositoryRequired extends AbstractCarRepository implements CarRepository {

    @Autowired
    public CarRepositoryRequired(JdbcTemplate jdbcTemplate, ApplicationContext applicationContext) {
    ...
    public void insertCarAndUpdateCar(Car car) throws Exception {
        ...
        var bean = ((CarRepositoryRequired) applicationContext.getBean("carRepositoryRequired"));
